...
1. **资产骨架**（`481f31e`）：搭建 `docs/agents/`、`docs/adr/`、`docs/output/{report,prd,handoff}/`、`assets/{backup,images,video,theme}/` 标准目录树
...
- `docs/output/prd/readme-diagrams/VISUAL-DIRECTION.md` 与规范要求的 `readme-diagram-brief.md` 存在命名/产出顺序上的历史漂移：`VISUAL-DIRECTION.md` 是先产出的方向稿，`readme-diagram-brief.md` 是本批次补录的规范契约层文档，两者内容协调一致，非冲突。
