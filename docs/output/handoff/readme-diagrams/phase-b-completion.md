...
- PRD/方向稿：`docs/output/prd/readme-diagrams/VISUAL-DIRECTION.md`（视觉方向：Dark Editorial Computational Atlas）
- 执行层：`docs/output/prd/readme-diagrams/readme-image-prompts.md`（六张图的 GPT image-to-image prompt）
- 契约层（本次补录）：`docs/output/prd/readme-diagrams/readme-diagram-brief.md`
